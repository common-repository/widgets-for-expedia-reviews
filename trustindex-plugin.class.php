<?php
class TrustindexPlugin_expedia
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Expedia Reviews", "do-not-care-Expedia");
